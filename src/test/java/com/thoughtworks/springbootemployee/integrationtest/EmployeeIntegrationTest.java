...
public class EmployeeIntegrationTest {
    ...
    void should_return_employee_when_add_employee_given_employee() throws Exception{
        ...
        Employee employee = new Employee("Zero", 25, "male", 30000.0, savedCompany.getCompany_id());
        employeeRepository.save(employee);
        String employeeJSON = "{\n" +
                "    \"name\": \"Zero\",\n" +
                "    \"age\": 25,\n" +
    ...
    void should_return_employee_when_update_employee_given_employee() throws Exception{
        ...
        Employee zero = new Employee("Zero", 25, "male", 30000.0, savedCompany.getCompany_id());
