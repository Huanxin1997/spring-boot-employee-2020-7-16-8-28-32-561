...
public class CompanyIntegrationTest {
    ...
    void should_return_companies_when_get_companies_given_nothing() throws Exception{
        ...
        mockMvc.perform(get("/companies"))
                ...
                .andExpect(jsonPath("$[0].company_id").value(savedCompany.getCompany_id()))
    ...
    void should_return_companies_when_get_companies_given_id() throws Exception{
        ...
        //when
        mockMvc.perform(get("/companies/" + savedCompany.getCompany_id()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.company_id").value(savedCompany.getCompany_id()))
    ...
    void should_return_employees_when_get_employees_given_company_id() throws Exception{
        ...
        //when
        mockMvc.perform(get("/companies/" + savedCompany.getCompany_id() + "/employees"))
                .andExpect(status().isOk())
    ...
    void should_return_company_when_update_company_given_company() throws Exception{
        ...
        //when
        mockMvc.perform(put("/companies/" + savedCompany.getCompany_id()).contentType(MediaType.APPLICATION_JSON).content(companiesJson))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.company_id").value(savedCompany.getCompany_id()))
    ...
    void should_delete_company_when_delete_company_given_id() throws Exception{
        ...
        //when
        mockMvc.perform(delete("/companies/" + savedCompany.getCompany_id()))
                .andExpect(status().isOk());
        assertEquals(false, companyRepository.findById(savedCompany.getCompany_id()).isPresent());
